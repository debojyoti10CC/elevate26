...
const eventsData = [
  { id: 1,  name: "Robo Wars",          category: "Technical",     description: "Battle your robot against opponents in an arena combat challenge. Build the toughest machine and dominate the ring.", difficulty: "Advanced",     icon: "⚔️" },
  { id: 2,  name: "Line Follower",      category: "Technical",     description: "Program an autonomous robot to follow a line track at maximum speed with precision and reliability.",               difficulty: "Intermediate", icon: "📡" },
  ...
  { id: 7,  name: "AI Hackathon",       category: "Technical",     description: "Build an AI/ML solution to a real-world problem in 4 hours. Any language, any framework.",                        difficulty: "Open",         icon: "🤖" },
  { id: 8,  name: "Paper Presentation", category: "Non-Technical", description: "Present your research paper or technical concept to a panel of judges. Innovation and clarity rewarded.",         difficulty: "Open",         icon: "📄" },
  { id: 9,  name: "Project Exhibition", category: "Non-Technical", description: "Showcase your project — hardware or software — to visitors and judges. Best project wins.",                       difficulty: "Open",         icon: "🏗️" },
  ...
  { id: 12, name: "Gaming",             category: "Non-Technical", description: "Compete in the esports tournament. Titles to be announced. Solo and team formats available.",                    difficulty: "Open",         icon: "🎮" },
];
...
const EventCard = ({ event }) => (
  <div className="relative flex-shrink-0 w-[82vw] sm:w-[60vw] md:w-[48vw] lg:w-[38vw] h-full bg-[#2a2725] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden flex flex-col justify-between p-6 md:p-8">
    {/* Top */}
...
const DesktopShowcase = () => {
  ...
  return (
    <section
      ref={containerRef}
      id="events"
      className="relative w-full h-screen overflow-hidden bg-[#181717]"
    >
      <p className="absolute top-6 left-8 text-[0.7rem] font-bold text-[#eae5dd] z-10 pointer-events-none">
        12 Events — Scroll to explore →
      </p>
      <div
        ref={innerRef}
        className="absolute top-0 left-0 h-full flex items-center gap-4 px-4 pt-14 pb-4"
