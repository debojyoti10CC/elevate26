...
const Welcome = () => {
    ...
    return (
        <section id="about" className="welcome-section w-full bg-[#0b0714] text-[#181126] px-5 md:px-7 pt-10 pb-12 md:pt-20 md:pb-16 font-inter">
            {/* Animated headline */}
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-4 md:p-4">
                ...
                <div className="md:w-1/2 w-full">
                    <p className="font-space text-[1rem] sm:text-[1.15rem] md:text-[2rem] text-[#9a8eb7] md:leading-[1.1] leading-[1.5] md:pr-24 font-normal">
                        ...
                        <span className="block mt-2 md:mt-0">Two days of AI, circuit design, and electrifying competition.</span>
                    </p>
                </div>
            </div>
        </section>
