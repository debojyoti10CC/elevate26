...
const Choose = () => {
    ...
    return (
        <section className="choose-section w-full min-h-screen md:h-dvh p-6 md:p-8 pt-10 pb-16 md:pb-8">
            <p className='text-[.7rem] text-[#eae4f5] choose-subtitle'>Explore ELEVATE Themes</p>
            <div className="lg:mt-10 mt-7 title-part origin-bottom ">
                {
                    chooseLines.map((line, index) => (
                        <h1 key={index} className={`choose-heading text-[#eae4f5] lg:text-[9.5rem] text-[3rem] leading-[0.9]`} font-medium tracking-tighter choose-title>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full text-[#9a8eb7] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-16'>
                ...
                <div className='lg:w-1/2 w-full'>
                    ...
                    <div className="flex flex-1 flex-wrap justify-start items-start gap-2 mt-8">
                        <div className="border-[1px] border-[#9a8eb7] text-[#9a8eb7] text-sm lg:text-[1.4rem] px-[16px] py-[4px] rounded-full">
                            Autonomous
                        </div>
                        <div className="border-[1px] border-[#eae4f5] text-[#eae4f5] text-sm lg:text-[1.4rem] px-[16px] py-[4px] rounded-full">
                            AI-Powered
                        </div>
                        <div className="border-[1px] border-[#9a8eb7] text-[#9a8eb7] text-sm lg:text-[1.4rem] px-[16px] py-[4px] rounded-full">
                            IEEE Certified
